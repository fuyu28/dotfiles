return {
  ...
  -- repeat those selections to select an outer text object.
  {
    ...
    opts = function()
      ...
      return {
        ...
        custom_textobjects = {
          ...
          g = ConfigUtil.mini.ai_buffer, -- buffer
    ...
    config = function(_, opts)
      ...
      ConfigUtil.on_load("which-key.nvim", function()
        vim.schedule(function()
          ConfigUtil.mini.ai_whichkey(opts)
        end)
      end)
    end,
  },
  ...
  -- while editing your Neovim configuration.
  {
    ...
    opts = {
      library = {
        ...
        { path = "lazy.nvim", words = { "ConfigUtil" } },
