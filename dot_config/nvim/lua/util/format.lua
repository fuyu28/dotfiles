...
function M.formatexpr()
  if ConfigUtil.has("conform.nvim") then
...
function M.info(buf)
  ...
  ConfigUtil[enabled and "info" or "warn"](
    table.concat(lines, "\n"),
...
function M.format(opts)
  ...
  if not done and opts and opts.force then
    ConfigUtil.warn("No formatter available", { title = "ConfigUtil" })
  end
end
...
function M.snacks_toggle(buf)
  return Snacks.toggle({
    ...
    get = function()
      ...
      return ConfigUtil.format.enabled()
    end,
    set = function(state)
      ConfigUtil.format.enable(state, buf)
    end,
  })
end
