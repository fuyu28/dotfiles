...
M.moved = {
  ...
  ui = {
    ...
    foldexpr = { "ConfigUtil.treesitter.foldexpr", stacktrace = false },
    fg = {
...
function M.decorate(name, mod)
  ...
  return setmetatable(mod, {
    __call = function(_, ...)
      ...
      ConfigUtil.deprecate("ConfigUtil." .. name, to)
    ...
    __index = function(_, k)
      if M.moved[name][k] then
        ...
        ConfigUtil.deprecate("ConfigUtil." .. name .. "." .. k, to, {
...
function M.lazygit()
  ConfigUtil.deprecate("ConfigUtil.lazygit", "Snacks.lazygit")
...
function M.toggle()
  ConfigUtil.deprecate("ConfigUtil.toggle", "Snacks.toggle")
  return {
    map = function() end,
    wrap = function()
      return {}
