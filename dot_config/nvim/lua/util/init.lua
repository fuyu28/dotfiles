...
---@field cmp util.cmp
---@field deprecated util.deprecated
local M = {}
...
for _, level in ipairs({ "info", "warn", "error" }) do
  M[level] = function(msg, opts)
    opts = opts or {}
    opts.title = opts.title or "ConfigUtil"
...
-- Safe wrapper around snacks to prevent errors when ConfigUtil is still installing
...
function M.set_default(option, value)
  ...
  local g = ConfigUtil.config._options[option] or vim.api.nvim_get_option_value(option, { scope = "global" })
