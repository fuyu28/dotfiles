...
function M.info()
  ...
  lines[#lines + 1] = "```"
  ConfigUtil.info(lines, { title = "ConfigUtil Roots" })
...
function M.setup()
  vim.api.nvim_create_user_command("LazyRoot", function()
    ConfigUtil.root.info()
  end, { desc = "ConfigUtil roots for the current buffer" })
...
function M.get(opts)
  ...
  return ConfigUtil.is_win() and ret:gsub("/", "\\") or ret
end
